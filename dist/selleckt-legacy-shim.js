...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['exports', 'selleckt', '_'], function (exports, selleckt, _) {
            factory((root.commonJsStrictGlobal = exports), selleckt.SingleSelleckt, _);
        });
    } else if (typeof exports === 'object') {
        // CommonJS
        factory(exports, require('selleckt').SingleSelleckt, require('underscore'));
    } else {
        // Browser globals
        factory(
            root.selleckt.SingleSelleckt, //because this module duck punches the SingleSelleckt proto
            root.selleckt.SingleSelleckt,
            root._
        );
    }
}(this, function (exports, SingleSelleckt, _) {
    'use strict';
    ...
    SingleSelleckt.prototype.DELAY_TIMEOUT = window.MutationObserver._period;
    ...
    exports.SingleSelleckt = SingleSelleckt;
}));
